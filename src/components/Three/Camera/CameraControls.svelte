<!-- https://threlte.xyz/docs/examples/camera/camera-controls -->
...
<script lang="ts">
  ...
  import type { CameraControlsEvents, CameraControlsProps, CameraControlsSlots } from './CameraControls.svelte.d.ts';
